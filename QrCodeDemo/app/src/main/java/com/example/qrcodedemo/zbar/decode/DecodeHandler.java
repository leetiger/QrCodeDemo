...
package com.example.qrcodedemo.zbar.decode;
...
import com.example.qrcodedemo.zbar.CaptureActivity;
...
final class DecodeHandler extends Handler {
    ...
    private void decode(byte[] data, int width, int height) {
        ...
        Log.i("lhq", "decode: width = " + width + " height = " + height);
        ...
        Log.i("lhq", "decode: " + mCropRect.toString());
        String result = null;
        if (zBarDecoder != null) {
            try {
