...
public enum Mode {
   ...
   * @throws1 IllegalArgumentException if bits do not correspond to a known mode
   */
   ...
   * @return number of bits used, in this QR Code symbol {@link1 Version}, to encode the
