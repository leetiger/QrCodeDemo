package com.example.qrcodedemo.zbar;
...
import com.example.qrcodedemo.zbar.camera.CameraManager;
import com.example.qrcodedemo.zbar.decode.MainHandler;
import com.example.qrcodedemo.zbar.utils.BeepManager;
...
public class CaptureActivity extends Activity implements SurfaceHolder.Callback {
    ...
    public Rect initCrop() {
        ...
        Log.e("lhq", "initCrop: cameraW = " + cameraWidth + " cameraH = " + cameraHeight);
        ...
        Log.e("lhq", "initCrop: location = " + location[0] + " location = " + location[1] + " cropWidth " + cropWidth + " cropHeight = " + cropHeight );
